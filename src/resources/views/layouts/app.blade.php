...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Gas To Go - @yield('title')</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                {{-- <div class="image">
                    <img src="{{ asset('assets/images/g2g-logo.png') }}" width="48" height="48" alt="User" />
                </div> --}}
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        {{ request()->session()->get('authUser')->userDetails->profile->firstName }}
                        {{ request()->session()->get('authUser')->userDetails->profile->lastName }}
                    </div>
                    <div class="email">{{ request()->session()->get('authUser')->userDetails->phoneNumber }}</div>
